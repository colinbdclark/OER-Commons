...
oer.content_submission.init_autocomplete = function() {
    ...
    $authors_input.focusout(function() {
...
oer.content_submission.init_license = function() {
    ...
    $license_type_buttons.change(function() {
        var $this = $(this);
        var value = $this.val();
        $cc_latest.hide();
        $cc_old.hide();
    ...
    $choose_cc_button.click(function(e) {
        e.preventDefault();
        $cc_latest.show();
        $cc_old.hide();
        $custom_license.hide();
    ...
    $cc_selection_widget.find("input[name='issue']").click(function(e) {
        e.preventDefault();
        var data = {};
        $cc_selection_widget.find("select").each(function() {
            var $this = $(this);
...
oer.content_submission.init_prepostrequisites_fields = function() {
    $("#id_has_prerequisites").change(function() {
        var $this = $(this);
        if ($this.attr("checked")) {
    ...
    $("#id_has_postrequisites").change(function() {
        var $this = $(this);
        if ($this.attr("checked")) {
