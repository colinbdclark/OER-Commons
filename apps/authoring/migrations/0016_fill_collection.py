...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        from authoring.models import COLLECTION_NAME, COLLECTION_SLUG

        collection = orm["materials.Collection"].objects.get_or_create(name=COLLECTION_NAME, slug=COLLECTION_SLUG)[0]
        for material in orm["authoring.AuthoredMaterial"].objects.all():
            material.collection = collection
            material.save()

        call_command("update_index", "authoring")
