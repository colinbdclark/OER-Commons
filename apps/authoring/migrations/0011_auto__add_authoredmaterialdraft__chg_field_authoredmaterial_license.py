...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('authoring_authoredmaterialdraft', (
            ...
            ('material', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['authoring.AuthoredMaterial'], unique=True)),
        ))
        ...
        # Adding M2M table for field subjects on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_subjects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterialdraft', models.ForeignKey(orm['authoring.authoredmaterialdraft'], null=False)),
            ('generalsubject', models.ForeignKey(orm['materials.generalsubject'], null=False))
        ))
        db.create_unique('authoring_authoredmaterialdraft_subjects', ['authoredmaterialdraft_id', 'generalsubject_id'])

        # Changing field 'AuthoredMaterial.license'
        db.alter_column('authoring_authoredmaterial', 'license_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.License'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subjects on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_subjects')
    ...
    models = {
        ...
        'authoring.authoredmaterialdraft': {
            ...
            'learning_goals': ('core.fields.AutoCreateManyToManyField', [], {'to': "orm['authoring.LearningGoal']", 'symmetrical': 'False'}),
            'license': ('core.fields.AutoCreateForeignKey', [], {'to': "orm['materials.License']", 'null': 'True'}),
            'material': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['authoring.AuthoredMaterial']", 'unique': 'True'}),
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['materials.GeneralSubject']", 'symmetrical': 'False'}),
            'summary': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'text': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'title': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200'})
