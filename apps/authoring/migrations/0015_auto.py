...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('authoring_authoredmaterialdraft_subjects', 'authoring_authoredmaterialdraft_general_subjects')
        db.rename_table('authoring_authoredmaterial_subjects', 'authoring_authoredmaterial_general_subjects')

    def backwards(self, orm):

        db.rename_table('authoring_authoredmaterialdraft_general_subjects', 'authoring_authoredmaterialdraft_subjects')
        db.rename_table('authoring_authoredmaterial_general_subjects', 'authoring_authoredmaterial_subjects')
