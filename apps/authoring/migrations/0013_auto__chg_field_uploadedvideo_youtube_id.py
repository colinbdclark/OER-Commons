...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadedVideo.youtube_id'
        db.alter_column('authoring_uploadedvideo', 'youtube_id', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'UploadedVideo.youtube_id'
        db.alter_column('authoring_uploadedvideo', 'youtube_id', self.gf('django.db.models.fields.CharField')(max_length=30))
