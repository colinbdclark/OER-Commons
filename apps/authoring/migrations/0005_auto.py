...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field grade_levels on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_grade_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterialdraft', models.ForeignKey(orm['authoring.authoredmaterialdraft'], null=False)),
            ('gradelevel', models.ForeignKey(orm['common.gradelevel'], null=False))
        ))
        db.create_unique('authoring_authoredmaterialdraft_grade_levels', ['authoredmaterialdraft_id', 'gradelevel_id'])

        # Adding M2M table for field languages on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterialdraft', models.ForeignKey(orm['authoring.authoredmaterialdraft'], null=False)),
            ('language', models.ForeignKey(orm['materials.language'], null=False))
        ))
        db.create_unique('authoring_authoredmaterialdraft_languages', ['authoredmaterialdraft_id', 'language_id'])

        # Adding M2M table for field material_types on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_material_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterialdraft', models.ForeignKey(orm['authoring.authoredmaterialdraft'], null=False)),
            ('coursematerialtype', models.ForeignKey(orm['materials.coursematerialtype'], null=False))
        ))
        db.create_unique('authoring_authoredmaterialdraft_material_types', ['authoredmaterialdraft_id', 'coursematerialtype_id'])

        # Adding M2M table for field grade_levels on 'AuthoredMaterial'
        db.create_table('authoring_authoredmaterial_grade_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterial', models.ForeignKey(orm['authoring.authoredmaterial'], null=False)),
            ('gradelevel', models.ForeignKey(orm['common.gradelevel'], null=False))
        ))
        db.create_unique('authoring_authoredmaterial_grade_levels', ['authoredmaterial_id', 'gradelevel_id'])

        # Adding M2M table for field languages on 'AuthoredMaterial'
        db.create_table('authoring_authoredmaterial_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterial', models.ForeignKey(orm['authoring.authoredmaterial'], null=False)),
            ('language', models.ForeignKey(orm['materials.language'], null=False))
        ))
        db.create_unique('authoring_authoredmaterial_languages', ['authoredmaterial_id', 'language_id'])

        # Adding M2M table for field material_types on 'AuthoredMaterial'
        db.create_table('authoring_authoredmaterial_material_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterial', models.ForeignKey(orm['authoring.authoredmaterial'], null=False)),
            ('coursematerialtype', models.ForeignKey(orm['materials.coursematerialtype'], null=False))
        ))
        db.create_unique('authoring_authoredmaterial_material_types', ['authoredmaterial_id', 'coursematerialtype_id'])

        for model in (orm["authoring.AuthoredMaterialDraft"], orm["authoring.AuthoredMaterial"]):
            for object in model.objects.all():
                if object.grade_level:
                    object.grade_levels = [object.grade_level]
                if object.language:
                    object.languages = [object.language]
                if object.material_type:
                    object.material_types = [object.material_type]
                object.save()


    def backwards(self, orm):

        # Removing M2M table for field grade_levels on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_grade_levels')

        # Removing M2M table for field languages on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_languages')

        # Removing M2M table for field material_types on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_material_types')

        # Removing M2M table for field grade_levels on 'AuthoredMaterial'
        db.delete_table('authoring_authoredmaterial_grade_levels')

        # Removing M2M table for field languages on 'AuthoredMaterial'
        db.delete_table('authoring_authoredmaterial_languages')

        # Removing M2M table for field material_types on 'AuthoredMaterial'
        db.delete_table('authoring_authoredmaterial_material_types')
    ...
    models = {
        ...
        'authoring.authoredmaterial': {
            ...
            'grade_level': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['common.GradeLevel']"}),
            ...
            'language': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['materials.Language']"}),
            ...
            'material_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['materials.CourseMaterialType']"}),
