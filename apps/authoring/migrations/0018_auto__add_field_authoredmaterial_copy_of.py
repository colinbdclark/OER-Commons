...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterial.copy_of'
        db.add_column('authoring_authoredmaterial', 'copy_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authoring.AuthoredMaterial'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthoredMaterial.copy_of'
        db.delete_column('authoring_authoredmaterial', 'copy_of_id')
    ...
    models = {
        ...
        'authoring.authoredmaterial': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['materials.Collection']", 'null': 'True'}),
            'copy_of': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authoring.AuthoredMaterial']", 'null': 'True', 'blank': 'True'}),
        ...
        'saveditems.saveditem': {
            'Meta': {'unique_together': "(('user', 'content_type', 'object_id'),)", 'object_name': 'SavedItem'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
