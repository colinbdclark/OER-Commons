...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterialDraft.created_timestamp'
        db.add_column('authoring_authoredmaterialdraft', 'created_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 5, 0, 5, 31, 330420), blank=True), keep_default=False)

        # Adding field 'AuthoredMaterialDraft.modified_timestamp'
        db.add_column('authoring_authoredmaterialdraft', 'modified_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 4, 5, 0, 5, 40, 955586), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthoredMaterialDraft.created_timestamp'
        db.delete_column('authoring_authoredmaterialdraft', 'created_timestamp')

        # Deleting field 'AuthoredMaterialDraft.modified_timestamp'
        db.delete_column('authoring_authoredmaterialdraft', 'modified_timestamp')
