...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuthoredMaterialDraft.grade_level'
        db.delete_column('authoring_authoredmaterialdraft', 'grade_level_id')

        # Deleting field 'AuthoredMaterialDraft.material_type'
        db.delete_column('authoring_authoredmaterialdraft', 'material_type_id')

        # Deleting field 'AuthoredMaterialDraft.language'
        db.delete_column('authoring_authoredmaterialdraft', 'language_id')

        # Deleting field 'AuthoredMaterial.material_type'
        db.delete_column('authoring_authoredmaterial', 'material_type_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AuthoredMaterialDraft.grade_level'
        db.add_column('authoring_authoredmaterialdraft', 'grade_level', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['common.GradeLevel']), keep_default=False)

        # Adding field 'AuthoredMaterialDraft.material_type'
        db.add_column('authoring_authoredmaterialdraft', 'material_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['materials.CourseMaterialType']), keep_default=False)

        # Adding field 'AuthoredMaterialDraft.language'
        db.add_column('authoring_authoredmaterialdraft', 'language', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['materials.Language']), keep_default=False)

        # Adding field 'AuthoredMaterial.material_type'
        db.add_column('authoring_authoredmaterial', 'material_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['materials.CourseMaterialType']), keep_default=False)

        # Adding field 'AuthoredMaterial.grade_level'
        db.add_column('authoring_authoredmaterial', 'grade_level', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['common.GradeLevel']), keep_default=False)

        # Adding field 'AuthoredMaterial.language'
        db.add_column('authoring_authoredmaterial', 'language', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['materials.Language']), keep_default=False)
