...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field grade_sublevels on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_grade_sublevels', (
        ...
        db.create_unique('authoring_authoredmaterialdraft_grade_sublevels', ['authoredmaterialdraft_id', 'gradesublevel_id'])

        # Adding M2M table for field grades on 'AuthoredMaterialDraft'
        db.create_table('authoring_authoredmaterialdraft_grades', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterialdraft', models.ForeignKey(orm['authoring.authoredmaterialdraft'], null=False)),
            ('grade', models.ForeignKey(orm['common.grade'], null=False))
        ))
        db.create_unique('authoring_authoredmaterialdraft_grades', ['authoredmaterialdraft_id', 'grade_id'])

        # Adding M2M table for field grade_sublevels on 'AuthoredMaterial'
        db.create_table('authoring_authoredmaterial_grade_sublevels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterial', models.ForeignKey(orm['authoring.authoredmaterial'], null=False)),
            ('gradesublevel', models.ForeignKey(orm['common.gradesublevel'], null=False))
        ))
        db.create_unique('authoring_authoredmaterial_grade_sublevels', ['authoredmaterial_id', 'gradesublevel_id'])

        # Adding M2M table for field grades on 'AuthoredMaterial'
        db.create_table('authoring_authoredmaterial_grades', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoredmaterial', models.ForeignKey(orm['authoring.authoredmaterial'], null=False)),
            ('grade', models.ForeignKey(orm['common.grade'], null=False))
        ))
        db.create_unique('authoring_authoredmaterial_grades', ['authoredmaterial_id', 'grade_id'])

        # Remove all grade levels from existing materials
        for model in (orm["authoring.AuthoredMaterialDraft"], orm["authoring.AuthoredMaterial"]):
            for object in model.objects.all():
                object.grade_levels.clear()

    def backwards(self, orm):

        # Removing M2M table for field grade_sublevels on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_grade_sublevels')

        # Removing M2M table for field grades on 'AuthoredMaterialDraft'
        db.delete_table('authoring_authoredmaterialdraft_grades')

        # Removing M2M table for field grade_sublevels on 'AuthoredMaterial'
        db.delete_table('authoring_authoredmaterial_grade_sublevels')

        # Removing M2M table for field grades on 'AuthoredMaterial'
        db.delete_table('authoring_authoredmaterial_grades')
    ...
    models = {
        ...
        'authoring.uploadedvideo': {
            'Meta': {'object_name': 'UploadedVideo'},
            'created_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'html': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authoring.AuthoredMaterial']"}),
