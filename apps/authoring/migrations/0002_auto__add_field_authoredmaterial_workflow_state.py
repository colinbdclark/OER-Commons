...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterial.workflow_state'
        db.add_column('authoring_authoredmaterial', 'workflow_state', self.gf('django.db.models.fields.CharField')(default=u'private', max_length=50), keep_default=False)

        for material in orm["authoring.AuthoredMaterial"].objects.all():
            material.workflow_state = u"published" if material.published else u"private"
            material.save()


    def backwards(self, orm):

        # Deleting field 'AuthoredMaterial.workflow_state'
        db.delete_column('authoring_authoredmaterial', 'workflow_state')
