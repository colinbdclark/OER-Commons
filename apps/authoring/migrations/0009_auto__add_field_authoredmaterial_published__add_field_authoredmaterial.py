...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterial.published'
        db.add_column('authoring_authoredmaterial', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AuthoredMaterial.created_timestamp'
        db.add_column('authoring_authoredmaterial', 'created_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 2, 9, 4, 24, 43, 741882), blank=True), keep_default=False)

        # Adding field 'AuthoredMaterial.modified_timestamp'
        db.add_column('authoring_authoredmaterial', 'modified_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 2, 9, 4, 24, 57, 734968), blank=True), keep_default=False)

        # Changing field 'AuthoredMaterial.license'
        db.alter_column('authoring_authoredmaterial', 'license_id', self.gf('utils.fields.AutoCreateForeignKey')(to=orm['materials.License'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'AuthoredMaterial.published'
        db.delete_column('authoring_authoredmaterial', 'published')

        # Deleting field 'AuthoredMaterial.created_timestamp'
        db.delete_column('authoring_authoredmaterial', 'created_timestamp')

        # Deleting field 'AuthoredMaterial.modified_timestamp'
        db.delete_column('authoring_authoredmaterial', 'modified_timestamp')

        # Changing field 'AuthoredMaterial.license'
        db.alter_column('authoring_authoredmaterial', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['materials.License'], null=True))
    ...
    models = {
        ...
        'authoring.authoredmaterial': {
            ...
            'license': ('utils.fields.AutoCreateForeignKey', [], {'to': "orm['materials.License']", 'null': 'True'}),
