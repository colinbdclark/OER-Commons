...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('authoring_authoredmaterialdraft', 'material_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['materials.CourseMaterialType'], null=True), keep_default=False)

        # Adding field 'AuthoredMaterial.material_type'
        db.add_column('authoring_authoredmaterial', 'material_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['materials.CourseMaterialType'], null=True), keep_default=False)
    ...
    models = {
        ...
        'authoring.authoredmaterial': {
            ...
            'material_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['materials.CourseMaterialType']", 'null': 'True'}),
