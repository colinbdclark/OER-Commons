...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterial.collection'
        db.add_column('authoring_authoredmaterial', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['materials.Collection'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthoredMaterial.collection'
        db.delete_column('authoring_authoredmaterial', 'collection_id')
