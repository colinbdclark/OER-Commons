...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('authoring_image', 'caption', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.caption'
        db.delete_column('authoring_image', 'caption')
    ...
    models = {
        ...
        'authoring.image': {
            ...
            'caption': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
