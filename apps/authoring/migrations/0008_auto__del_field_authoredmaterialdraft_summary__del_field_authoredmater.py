...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AuthoredMaterialDraft.summary'
        db.delete_column('authoring_authoredmaterialdraft', 'summary')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AuthoredMaterialDraft.summary'
        db.add_column('authoring_authoredmaterialdraft', 'summary', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)
