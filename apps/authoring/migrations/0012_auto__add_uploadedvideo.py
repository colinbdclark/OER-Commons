...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UploadedVideo'
        db.create_table('authoring_uploadedvideo', (
            ...
            ('youtube_id', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.send_create_signal('authoring', ['UploadedVideo'])


    def backwards(self, orm):
        
        # Deleting model 'UploadedVideo'
        db.delete_table('authoring_uploadedvideo')
    ...
    models = {
        ...
        'authoring.uploadedvideo': {
            ...
            'youtube_id': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'common.grade': {
