...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterial.screenshot'
        db.add_column('authoring_authoredmaterial', 'screenshot', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthoredMaterial.screenshot'
        db.delete_column('authoring_authoredmaterial', 'screenshot')
