...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthoredMaterialDraft.abstract'
        db.add_column('authoring_authoredmaterialdraft', 'abstract', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)

        # Adding field 'AuthoredMaterial.abstract'
        db.add_column('authoring_authoredmaterial', 'abstract', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)

        for model in ("authoring.AuthoredMaterialDraft", "authoring.AuthoredMaterial"):
            model = orm[model]
            for instance in model.objects.all():
                instance.abstract = instance.summary
                instance.save()


    def backwards(self, orm):

        # Deleting field 'AuthoredMaterialDraft.abstract'
        db.delete_column('authoring_authoredmaterialdraft', 'abstract')

        # Deleting field 'AuthoredMaterial.abstract'
        db.delete_column('authoring_authoredmaterial', 'abstract')
