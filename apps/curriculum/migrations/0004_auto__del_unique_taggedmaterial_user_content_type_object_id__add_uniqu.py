...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TaggedMaterial', fields ['user', 'content_type', 'object_id']
        db.delete_unique('curriculum_taggedmaterial', ['user_id', 'content_type_id', 'object_id'])

        # Adding unique constraint on 'TaggedMaterial', fields ['tag', 'user', 'content_type', 'object_id']
        db.create_unique('curriculum_taggedmaterial', ['tag_id', 'user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TaggedMaterial', fields ['tag', 'user', 'content_type', 'object_id']
        db.delete_unique('curriculum_taggedmaterial', ['tag_id', 'user_id', 'content_type_id', 'object_id'])

        # Adding unique constraint on 'TaggedMaterial', fields ['user', 'content_type', 'object_id']
        db.create_unique('curriculum_taggedmaterial', ['user_id', 'content_type_id', 'object_id'])
