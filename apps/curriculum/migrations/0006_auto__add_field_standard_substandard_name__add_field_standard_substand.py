...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('curriculum_standard', ['name'])

        # Removing unique constraint on 'Standard', fields ['code']
        db.delete_unique('curriculum_standard', ['code'])

        # Adding field 'Standard.substandard_name'
        db.add_column('curriculum_standard', 'substandard_name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100), keep_default=False)

        # Adding field 'Standard.substandard_code'
        db.add_column('curriculum_standard', 'substandard_code', self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, db_index=True), keep_default=False)

        # Adding unique constraint on 'Standard', fields ['code', 'substandard_code']
        db.create_unique('curriculum_standard', ['code', 'substandard_code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Standard', fields ['code', 'substandard_code']
        db.delete_unique('curriculum_standard', ['code', 'substandard_code'])

        # Deleting field 'Standard.substandard_name'
        db.delete_column('curriculum_standard', 'substandard_name')

        # Deleting field 'Standard.substandard_code'
        db.delete_column('curriculum_standard', 'substandard_code')

        # Adding unique constraint on 'Standard', fields ['code']
        db.create_unique('curriculum_standard', ['code'])

        # Adding unique constraint on 'Standard', fields ['name']
        db.create_unique('curriculum_standard', ['name'])
    ...
    models = {
        ...
        'curriculum.standard': {
            ...
            'substandard_name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100'})
        },
