...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlignmentTag.code'
        db.alter_column('curriculum_alignmenttag', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'AlignmentTag.code'
        db.alter_column('curriculum_alignmenttag', 'code', self.gf('django.db.models.fields.CharField')(max_length=4))
