...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("common", "0002_auto__add_grade"),
    )

    def forwards(self, orm):

        # Changing field 'AlignmentTag.end_grade'
        db.alter_column('curriculum_alignmenttag', 'end_grade_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['common.Grade']))

        # Changing field 'AlignmentTag.grade'
        db.alter_column('curriculum_alignmenttag', 'grade_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Grade']))
    ...
    def backwards(self, orm):
        ...
        db.create_table('curriculum_grade', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True, db_index=True)),
        ...
        # Changing field 'AlignmentTag.end_grade'
        db.alter_column('curriculum_alignmenttag', 'end_grade_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['curriculum.Grade']))

        # Changing field 'AlignmentTag.grade'
        db.alter_column('curriculum_alignmenttag', 'grade_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['curriculum.Grade']))
