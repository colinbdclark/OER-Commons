...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlignmentTag.subcategory'
        db.add_column('curriculum_alignmenttag', 'subcategory', self.gf('django.db.models.fields.TextField')(default=u''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlignmentTag.subcategory'
        db.delete_column('curriculum_alignmenttag', 'subcategory')
