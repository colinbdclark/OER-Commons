...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlignmentTag.end_grade'
        db.add_column('curriculum_alignmenttag', 'end_grade', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['curriculum.Grade']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlignmentTag.end_grade'
        db.delete_column('curriculum_alignmenttag', 'end_grade_id')
