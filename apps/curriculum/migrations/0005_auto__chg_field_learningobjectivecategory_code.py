...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LearningObjectiveCategory.code'
        db.alter_column('curriculum_learningobjectivecategory', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=8))


    def backwards(self, orm):
        
        # Changing field 'LearningObjectiveCategory.code'
        db.alter_column('curriculum_learningobjectivecategory', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, unique=True))
