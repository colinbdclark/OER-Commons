...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AlignmentTag', fields ['grade', 'category', 'code', 'standard']
        db.delete_unique('curriculum_alignmenttag', ['grade_id', 'category_id', 'code', 'standard_id'])

        # Adding unique constraint on 'AlignmentTag', fields ['grade', 'category', 'code']
        db.create_unique('curriculum_alignmenttag', ['grade_id', 'category_id', 'code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AlignmentTag', fields ['grade', 'category', 'code']
        db.delete_unique('curriculum_alignmenttag', ['grade_id', 'category_id', 'code'])

        # Adding unique constraint on 'AlignmentTag', fields ['grade', 'category', 'code', 'standard']
        db.create_unique('curriculum_alignmenttag', ['grade_id', 'category_id', 'code', 'standard_id'])
