...
def providers(request, microsite=None):
    ...
    course_collections_facets = dict(get_facets_for_field("collection", Course, facet_limit=300))
    ...
    library_collections_facets = dict(get_facets_for_field("collection", Library, facet_limit=300))
