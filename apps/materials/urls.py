...
urlpatterns = patterns('',
    ...
    url(r"^(?:(?P<microsite>[^/]+)/)?search/?$", "index.index", name="search", kwargs={"search": True}),
    ...
    url(r"^green/oer", "microsites.green_browse", name="green_browse"),
    ...
    url(r"^license-picker/issue/?$", "license_picker.issue", name="license_issue"),
