...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('materials_course', 'postrequisite_2_id', self.gf('core.fields.AutoCreateForeignKey')(null=True, to=orm['materials.RelatedMaterial']))

        # Changing field 'Course.postrequisite_1'
        db.alter_column('materials_course', 'postrequisite_1_id', self.gf('core.fields.AutoCreateForeignKey')(null=True, to=orm['materials.RelatedMaterial']))

        # Changing field 'Course.collection'
        db.alter_column('materials_course', 'collection_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.Collection'], null=True))

        # Changing field 'Course.prerequisite_1'
        db.alter_column('materials_course', 'prerequisite_1_id', self.gf('core.fields.AutoCreateForeignKey')(null=True, to=orm['materials.RelatedMaterial']))

        # Changing field 'Course.institution'
        db.alter_column('materials_course', 'institution_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.Institution'], null=True))

        # Changing field 'Course.license'
        db.alter_column('materials_course', 'license_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.License']))

        # Changing field 'Course.prerequisite_2'
        db.alter_column('materials_course', 'prerequisite_2_id', self.gf('core.fields.AutoCreateForeignKey')(null=True, to=orm['materials.RelatedMaterial']))

        # Changing field 'Course.derived_from'
        db.alter_column('materials_course', 'derived_from_id', self.gf('core.fields.AutoCreateForeignKey')(null=True, to=orm['materials.RelatedMaterial']))

        # Changing field 'CommunityItem.license'
        db.alter_column('materials_communityitem', 'license_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.License']))

        # Changing field 'Library.collection'
        db.alter_column('materials_library', 'collection_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.Collection'], null=True))

        # Changing field 'Library.institution'
        db.alter_column('materials_library', 'institution_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.Institution'], null=True))

        # Changing field 'Library.license'
        db.alter_column('materials_library', 'license_id', self.gf('core.fields.AutoCreateForeignKey')(to=orm['materials.License']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.collection'
        db.alter_column('materials_course', 'collection_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.Collection'], null=True))
        ...
        # Changing field 'Course.institution'
        db.alter_column('materials_course', 'institution_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.Institution'], null=True))

        # Changing field 'Course.license'
        db.alter_column('materials_course', 'license_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.License']))
        ...
        # Changing field 'CommunityItem.license'
        db.alter_column('materials_communityitem', 'license_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.License']))

        # Changing field 'Library.collection'
        db.alter_column('materials_library', 'collection_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.Collection'], null=True))

        # Changing field 'Library.institution'
        db.alter_column('materials_library', 'institution_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.Institution'], null=True))

        # Changing field 'Library.license'
        db.alter_column('materials_library', 'license_id', self.gf('materials.models.common.AutoCreateForeignKey')(to=orm['materials.License']))
    ...
    models = {
        ...
        'materials.communityitem': {
            ...
            'authors': ('core.fields.AutoCreateManyToManyField', [], {'to': "orm['materials.Author']", 'symmetrical': 'False'}),
            ...
            'license': ('core.fields.AutoCreateForeignKey', [], {'to': "orm['materials.License']"}),
        ...
        'materials.course': {
            ...
            'audience': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'authors': ('core.fields.AutoCreateManyToManyField', [], {'to': "orm['materials.Author']", 'symmetrical': 'False'}),
            'collection': ('core.fields.AutoCreateForeignKey', [], {'to': "orm['materials.Collection']", 'null': 'True', 'blank': 'True'}),
            'content_creation_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'derived_from': ('core.fields.AutoCreateForeignKey', [], {'blank': 'True', 'related_name': "'derived'", 'null': 'True', 'to': "orm['materials.RelatedMaterial']"}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'featured_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'general_subjects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['materials.GeneralSubject']", 'symmetrical': 'False'}),
            'geographic_relevance': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['materials.GeographicRelevance']", 'symmetrical': 'False'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_rss': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'institution': ('core.fields.AutoCreateForeignKey', [], {'to': "orm['materials.Institution']", 'null': 'True', 'blank': 'True'}),
            'keywords': ('core.fields.AutoCreateManyToManyField', [], {'to': "orm['materials.Keyword']", 'symmetrical': 'False'}),
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['materials.Language']", 'symmetrical': 'False'}),
            'license': ('core.fields.AutoCreateForeignKey', [], {'to': "orm['materials.License']"}),
            ...
            'new_level': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'new_subject': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'postrequisite_1': ('core.fields.AutoCreateForeignKey', [], {'blank': 'True', 'related_name': "'postrequisites_1'", 'null': 'True', 'to': "orm['materials.RelatedMaterial']"}),
            'postrequisite_2': ('core.fields.AutoCreateForeignKey', [], {'blank': 'True', 'related_name': "'postrequisites_2'", 'null': 'True', 'to': "orm['materials.RelatedMaterial']"}),
            'prerequisite_1': ('core.fields.AutoCreateForeignKey', [], {'blank': 'True', 'related_name': "'prerequisites_1'", 'null': 'True', 'to': "orm['materials.RelatedMaterial']"}),
            'prerequisite_2': ('core.fields.AutoCreateForeignKey', [], {'blank': 'True', 'related_name': "'prerequisites_2'", 'null': 'True', 'to': "orm['materials.RelatedMaterial']"}),
        ...
        'materials.topic': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('core.fields.AutoCreateManyToManyField', [], {'symmetrical': 'False', 'to': "orm['materials.Keyword']", 'null': 'True', 'blank': 'True'}),
