...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseMaterialType.order'
        db.add_column('materials_coursematerialtype', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CourseMaterialType.order'
        db.delete_column('materials_coursematerialtype', 'order')
