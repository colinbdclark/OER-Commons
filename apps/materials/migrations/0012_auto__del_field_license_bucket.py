...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'License.bucket'
        db.delete_column('materials_license', 'bucket')


    def backwards(self, orm):
        
        # Adding field 'License.bucket'
        db.add_column('materials_license', 'bucket', self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True), keep_default=False)
