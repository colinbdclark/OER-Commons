...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Course', fields ['url']
        db.create_index('materials_course', ['url'])

        # Adding index on 'CommunityItem', fields ['url']
        db.create_index('materials_communityitem', ['url'])

        # Adding index on 'Library', fields ['url']
        db.create_index('materials_library', ['url'])


    def backwards(self, orm):
        
        # Removing index on 'Library', fields ['url']
        db.delete_index('materials_library', ['url'])

        # Removing index on 'CommunityItem', fields ['url']
        db.delete_index('materials_communityitem', ['url'])

        # Removing index on 'Course', fields ['url']
        db.delete_index('materials_course', ['url'])
