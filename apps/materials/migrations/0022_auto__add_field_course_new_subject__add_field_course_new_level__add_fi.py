...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.new_subject'
        db.add_column('materials_course', 'new_subject', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Course.new_level'
        db.add_column('materials_course', 'new_level', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Course.audience'
        db.add_column('materials_course', 'audience', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'CommunityItem.new_subject'
        db.add_column('materials_communityitem', 'new_subject', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'CommunityItem.new_level'
        db.add_column('materials_communityitem', 'new_level', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'CommunityItem.audience'
        db.add_column('materials_communityitem', 'audience', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Library.new_subject'
        db.add_column('materials_library', 'new_subject', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Library.new_level'
        db.add_column('materials_library', 'new_level', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Library.audience'
        db.add_column('materials_library', 'audience', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.new_subject'
        db.delete_column('materials_course', 'new_subject')

        # Deleting field 'Course.new_level'
        db.delete_column('materials_course', 'new_level')

        # Deleting field 'Course.audience'
        db.delete_column('materials_course', 'audience')

        # Deleting field 'CommunityItem.new_subject'
        db.delete_column('materials_communityitem', 'new_subject')

        # Deleting field 'CommunityItem.new_level'
        db.delete_column('materials_communityitem', 'new_level')

        # Deleting field 'CommunityItem.audience'
        db.delete_column('materials_communityitem', 'audience')

        # Deleting field 'Library.new_subject'
        db.delete_column('materials_library', 'new_subject')

        # Deleting field 'Library.new_level'
        db.delete_column('materials_library', 'new_level')

        # Deleting field 'Library.audience'
        db.delete_column('materials_library', 'audience')
