...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.country'
        db.alter_column('materials_author', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Country'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table('materials_country', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=2, unique=True, db_index=True)),
        ...
        # Changing field 'Author.country'
        db.alter_column('materials_author', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['materials.Country'], null=True))
