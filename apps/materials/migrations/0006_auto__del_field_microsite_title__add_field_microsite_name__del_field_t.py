...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Microsite.title'
        db.delete_column('materials_microsite', 'title')

        # Adding field 'Microsite.name'
        db.add_column('materials_microsite', 'name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100), keep_default=False)

        # Deleting field 'Topic.title'
        db.delete_column('materials_topic', 'title')

        # Adding field 'Topic.name'
        db.add_column('materials_topic', 'name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Microsite.title'
        db.add_column('materials_microsite', 'title', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Deleting field 'Microsite.name'
        db.delete_column('materials_microsite', 'name')

        # Adding field 'Topic.title'
        db.add_column('materials_topic', 'title', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100), keep_default=False)

        # Deleting field 'Topic.name'
        db.delete_column('materials_topic', 'name')
    ...
    models = {
        ...
        'materials.topic': {
            'Meta': {'ordering': "['microsite', 'parent__id', 'id']", 'object_name': 'Topic'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('materials.models.common.AutoCreateManyToManyField', [], {'to': "orm['materials.Keyword']", 'symmetrical': 'False'}),
