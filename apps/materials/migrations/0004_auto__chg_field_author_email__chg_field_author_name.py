...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('materials_author', 'email', self.gf('django.db.models.fields.EmailField')(max_length=500))

        # Changing field 'Author.name'
        db.alter_column('materials_author', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Author.email'
        db.alter_column('materials_author', 'email', self.gf('django.db.models.fields.EmailField')(max_length=200))

        # Changing field 'Author.name'
        db.alter_column('materials_author', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
