...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.http_status'
        db.alter_column('materials_course', 'http_status', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CommunityItem.http_status'
        db.alter_column('materials_communityitem', 'http_status', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Library.http_status'
        db.alter_column('materials_library', 'http_status', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.http_status'
        db.alter_column('materials_course', 'http_status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CommunityItem.http_status'
        db.alter_column('materials_communityitem', 'http_status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Library.http_status'
        db.alter_column('materials_library', 'http_status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'materials.communityitem': {
            ...
            'http_status': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
