...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collection.disable_alignment_evaluation'
        db.add_column('materials_collection', 'disable_alignment_evaluation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collection.disable_alignment_evaluation'
        db.delete_column('materials_collection', 'disable_alignment_evaluation')
