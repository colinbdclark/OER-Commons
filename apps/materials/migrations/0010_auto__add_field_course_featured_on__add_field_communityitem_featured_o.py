...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.featured_on'
        db.add_column('materials_course', 'featured_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'CommunityItem.featured_on'
        db.add_column('materials_communityitem', 'featured_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Library.featured_on'
        db.add_column('materials_library', 'featured_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.featured_on'
        db.delete_column('materials_course', 'featured_on')

        # Deleting field 'CommunityItem.featured_on'
        db.delete_column('materials_communityitem', 'featured_on')

        # Deleting field 'Library.featured_on'
        db.delete_column('materials_library', 'featured_on')
