...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.url_fetched_on'
        db.add_column('materials_course', 'url_fetched_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True, default=now), keep_default=False)

        # Adding field 'CommunityItem.url_fetched_on'
        db.add_column('materials_communityitem', 'url_fetched_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True, default=now), keep_default=False)

        # Adding field 'Library.url_fetched_on'
        db.add_column('materials_library', 'url_fetched_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True, default=now), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Course.url_fetched_on'
        db.delete_column('materials_course', 'url_fetched_on')

        # Deleting field 'CommunityItem.url_fetched_on'
        db.delete_column('materials_communityitem', 'url_fetched_on')

        # Deleting field 'Library.url_fetched_on'
        db.delete_column('materials_library', 'url_fetched_on')
