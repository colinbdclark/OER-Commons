...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.is_indexed'
        db.add_column('materials_course', 'is_indexed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'CommunityItem.is_indexed'
        db.add_column('materials_communityitem', 'is_indexed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'Library.is_indexed'
        db.add_column('materials_library', 'is_indexed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.is_indexed'
        db.delete_column('materials_course', 'is_indexed')

        # Deleting field 'CommunityItem.is_indexed'
        db.delete_column('materials_communityitem', 'is_indexed')

        # Deleting field 'Library.is_indexed'
        db.delete_column('materials_library', 'is_indexed')
