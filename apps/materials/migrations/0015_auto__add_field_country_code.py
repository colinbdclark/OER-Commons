...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('materials_country', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=2, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.code'
        db.delete_column('materials_country', 'code')
