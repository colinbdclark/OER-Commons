...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Evaluation', fields ['confirmed']
        db.create_index('rubrics_evaluation', ['confirmed'])

        # Adding index on 'Evaluation', fields ['object_id']
        db.create_index('rubrics_evaluation', ['object_id'])


    def backwards(self, orm):
        
        # Removing index on 'Evaluation', fields ['object_id']
        db.delete_index('rubrics_evaluation', ['object_id'])

        # Removing index on 'Evaluation', fields ['confirmed']
        db.delete_index('rubrics_evaluation', ['confirmed'])
    ...
    models = {
        ...
        'rubrics.evaluation': {
            ...
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
