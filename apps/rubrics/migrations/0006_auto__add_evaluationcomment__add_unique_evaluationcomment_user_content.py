...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EvaluationComment'
        db.create_table('rubrics_evaluationcomment', (
        ...
        db.send_create_signal('rubrics', ['EvaluationComment'])

        # Adding unique constraint on 'EvaluationComment', fields ['user', 'content_type', 'object_id']
        db.create_unique('rubrics_evaluationcomment', ['user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EvaluationComment', fields ['user', 'content_type', 'object_id']
        db.delete_unique('rubrics_evaluationcomment', ['user_id', 'content_type_id', 'object_id'])

        # Deleting model 'EvaluationComment'
        db.delete_table('rubrics_evaluationcomment')
    ...
    models = {
        ...
        'rubrics.evaluationcomment': {
            'Meta': {'unique_together': "(['user', 'content_type', 'object_id'],)", 'object_name': 'EvaluationComment'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
