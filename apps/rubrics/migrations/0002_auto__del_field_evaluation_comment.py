...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Evaluation.comment'
        db.delete_column('rubrics_evaluation', 'comment')


    def backwards(self, orm):
        
        # Adding field 'Evaluation.comment'
        db.add_column('rubrics_evaluation', 'comment', self.gf('django.db.models.fields.TextField')(default=u'', blank=True), keep_default=False)
