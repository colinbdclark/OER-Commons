...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rubric.video_link'
        db.add_column('rubrics_rubric', 'video_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rubric.video_link'
        db.delete_column('rubrics_rubric', 'video_link')
