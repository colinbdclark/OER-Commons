...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RubricScore', fields ['rubric', 'user', 'content_type', 'object_id']
        db.create_unique('rubrics_rubricscore', ['rubric_id', 'user_id', 'content_type_id', 'object_id'])

        # Adding unique constraint on 'StandardAlignmentScore', fields ['alignment_tag', 'user', 'content_type', 'object_id']
        db.create_unique('rubrics_standardalignmentscore', ['alignment_tag_id', 'user_id', 'content_type_id', 'object_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'StandardAlignmentScore', fields ['alignment_tag', 'user', 'content_type', 'object_id']
        db.delete_unique('rubrics_standardalignmentscore', ['alignment_tag_id', 'user_id', 'content_type_id', 'object_id'])

        # Removing unique constraint on 'RubricScore', fields ['rubric', 'user', 'content_type', 'object_id']
        db.delete_unique('rubrics_rubricscore', ['rubric_id', 'user_id', 'content_type_id', 'object_id'])
    ...
    models = {
        ...
        'rubrics.rubricscore': {
            'Meta': {'unique_together': "(['user', 'content_type', 'object_id', 'rubric'],)", 'object_name': 'RubricScore'},
        ...
        'rubrics.rubricscorevalue': {
            'Meta': {'unique_together': "(['rubric', 'value'],)", 'object_name': 'RubricScoreValue'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rubrics.standardalignmentscore': {
            'Meta': {'unique_together': "(['user', 'content_type', 'object_id', 'alignment_tag'],)", 'object_name': 'StandardAlignmentScore'},
