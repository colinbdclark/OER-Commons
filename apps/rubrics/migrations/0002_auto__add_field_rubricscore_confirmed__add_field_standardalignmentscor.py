...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RubricScore.confirmed'
        db.add_column('rubrics_rubricscore', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'StandardAlignmentScore.confirmed'
        db.add_column('rubrics_standardalignmentscore', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RubricScore.confirmed'
        db.delete_column('rubrics_rubricscore', 'confirmed')

        # Deleting field 'StandardAlignmentScore.confirmed'
        db.delete_column('rubrics_standardalignmentscore', 'confirmed')
    ...
    models = {
        ...
        'rubrics.rubricscorevalue': {
            'Meta': {'ordering': "['rubric', 'id']", 'object_name': 'RubricScoreValue'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
