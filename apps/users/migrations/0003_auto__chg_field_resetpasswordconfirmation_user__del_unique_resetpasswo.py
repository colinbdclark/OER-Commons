...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'RegistrationConfirmation', fields ['user']
        db.delete_unique('users_registrationconfirmation', ['user_id'])

        # Removing unique constraint on 'ResetPasswordConfirmation', fields ['user']
        db.delete_unique('users_resetpasswordconfirmation', ['user_id'])

        # Changing field 'ResetPasswordConfirmation.user'
        db.alter_column('users_resetpasswordconfirmation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'RegistrationConfirmation.user'
        db.alter_column('users_registrationconfirmation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'ResetPasswordConfirmation.user'
        db.alter_column('users_resetpasswordconfirmation', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'ResetPasswordConfirmation', fields ['user']
        db.create_unique('users_resetpasswordconfirmation', ['user_id'])

        # Changing field 'RegistrationConfirmation.user'
        db.alter_column('users_registrationconfirmation', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'RegistrationConfirmation', fields ['user']
        db.create_unique('users_registrationconfirmation', ['user_id'])
    ...
    models = {
        ...
        'users.resetpasswordconfirmation': {
            ...
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'LNkYGAAKZXk2mM5u7Anb'", 'unique': 'True', 'max_length': '20'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }
