...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.show_toolbar'
        db.add_column('users_profile', 'show_toolbar', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
        Preferences = orm['preferences.preferences']
        Profile = orm['users.profile']
        for pref in Preferences.objects.all():
            profile, _ = Profile.objects.get_or_create(user=pref.user)
            if pref.show_toolbar is False:
                profile.show_toolbar = False
                profile.save()


    def backwards(self, orm):

        # Deleting field 'Profile.show_toolbar'
        db.delete_column('users_profile', 'show_toolbar')
    ...
    models = {
        ...
        'preferences.preferences': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_toolbar': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'users.profile': {
            ...
            'educator_student_levels': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['common.StudentLevel']", 'null': 'True', 'blank': 'True'}),
            'educator_subjects': ('core.fields.AutoCreateManyToManyField', [], {'symmetrical': 'False', 'to': "orm['users.EducatorSubject']", 'null': 'True', 'blank': 'True'}),
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'grade_level': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.GradeLevel']", 'symmetrical': 'False'}),
            ...
            'privacy': ('django.db.models.fields.CharField', [], {'default': "u'full'", 'max_length': '10'}),
