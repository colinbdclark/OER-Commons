...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.wish_for_education'
        db.delete_column('users_profile', 'wish_for_education')

        # Adding field 'Profile.about_me'
        db.add_column('users_profile', 'about_me', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.wish_for_education'
        db.add_column('users_profile', 'wish_for_education', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Profile.about_me'
        db.delete_column('users_profile', 'about_me')
    ...
    models = {
        ...
        'users.resetpasswordconfirmation': {
            ...
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'EgYst9Cp37e9cARkVnqp'", 'unique': 'True', 'max_length': '20'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'users.role': {
