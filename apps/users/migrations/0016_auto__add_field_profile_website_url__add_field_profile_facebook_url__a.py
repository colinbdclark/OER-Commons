...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
        ...
        db.add_column('users_profile', 'twitter_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.skype_id'
        db.add_column('users_profile', 'skype_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.website_url'
        db.delete_column('users_profile', 'website_url')

        # Deleting field 'Profile.facebook_url'
        db.delete_column('users_profile', 'facebook_url')

        # Deleting field 'Profile.twitter_id'
        db.delete_column('users_profile', 'twitter_id')

        # Deleting field 'Profile.skype_id'
        db.delete_column('users_profile', 'skype_id')
    ...
    models = {
        ...
        'users.resetpasswordconfirmation': {
            ...
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'4AcsqXUUxvj57HWL6ZYg'", 'unique': 'True', 'max_length': '20'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'users.role': {
