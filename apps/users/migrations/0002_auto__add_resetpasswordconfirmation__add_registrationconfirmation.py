...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResetPasswordConfirmation'
        db.create_table('users_resetpasswordconfirmation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('key', self.gf('django.db.models.fields.CharField')(default='bdMCef6BF9Ru6M36hkTx', unique=True, max_length=20)),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('users', ['ResetPasswordConfirmation'])

        # Adding model 'RegistrationConfirmation'
        db.create_table('users_registrationconfirmation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ...
        db.send_create_signal('users', ['RegistrationConfirmation'])


    def backwards(self, orm):
        
        # Deleting model 'ResetPasswordConfirmation'
        db.delete_table('users_resetpasswordconfirmation')

        # Deleting model 'RegistrationConfirmation'
        db.delete_table('users_registrationconfirmation')
    ...
    models = {
        ...
        'users.resetpasswordconfirmation': {
            ...
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'g8KuypFDtA6eDWYzBfFb'", 'unique': 'True', 'max_length': '20'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        }
    }
