...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EducatorSubject.title'
        db.alter_column('users_educatorsubject', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'EducatorSubject.title'
        db.alter_column('users_educatorsubject', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
