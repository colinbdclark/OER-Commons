...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Visit'
        db.create_table('visitcounts_visit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
        ...
        db.send_create_signal('visitcounts', ['Visit'])


    def backwards(self, orm):
        
        # Deleting model 'Visit'
        db.delete_table('visitcounts_visit')
