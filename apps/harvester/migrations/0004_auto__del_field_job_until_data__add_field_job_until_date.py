...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.until_data'
        db.delete_column('harvester_job', 'until_data')

        # Adding field 'Job.until_date'
        db.add_column('harvester_job', 'until_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Job.until_data'
        db.add_column('harvester_job', 'until_data', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Job.until_date'
        db.delete_column('harvester_job', 'until_date')
    ...
    models = {
        ...
        'harvester.job': {
            ...
            'until_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        'harvester.set': {
            'Meta': {'ordering': "['repository', 'name', 'spec']", 'object_name': 'Set'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
