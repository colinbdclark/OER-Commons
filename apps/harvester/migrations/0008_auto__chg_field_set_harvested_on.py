...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Set.harvested_on'
        db.alter_column('harvester_set', 'harvested_on', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Set.harvested_on'
        db.alter_column('harvester_set', 'harvested_on', self.gf('django.db.models.fields.DateField')(null=True))
