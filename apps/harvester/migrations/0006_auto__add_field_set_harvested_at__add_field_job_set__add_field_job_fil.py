...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.set'
        db.add_column('harvester_job', 'set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['harvester.Set'], null=True, blank=True), keep_default=False)

        # Adding field 'Job.file'
        db.add_column('harvester_job', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Job.set'
        db.delete_column('harvester_job', 'set_id')

        # Deleting field 'Job.file'
        db.delete_column('harvester_job', 'file')
    ...
    models = {
        ...
        'harvester.set': {
            ...
            'harvested_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
