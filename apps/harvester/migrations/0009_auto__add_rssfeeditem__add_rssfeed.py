...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RSSFeedItem'
        db.create_table('harvester_rssfeeditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'', max_length=1000)),
            ('description', self.gf('django.db.models.fields.TextField')(default=u'')),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=None)),
            ('keywords', self.gf('django.db.models.fields.TextField')(default=u'')),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['harvester.RSSFeed'])),
            ('exported', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('harvester', ['RSSFeedItem'])

        # Adding model 'RSSFeed'
        db.create_table('harvester_rssfeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'', max_length=1000)),
        ))
        db.send_create_signal('harvester', ['RSSFeed'])


    def backwards(self, orm):
        
        # Deleting model 'RSSFeedItem'
        db.delete_table('harvester_rssfeeditem')

        # Deleting model 'RSSFeed'
        db.delete_table('harvester_rssfeed')
    ...
    models = {
        ...
        'harvester.rssfeeditem': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['harvester.RSSFeed']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
