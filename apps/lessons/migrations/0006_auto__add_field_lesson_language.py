...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lessons_lesson', 'language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Language'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lesson.language'
        db.delete_column('lessons_lesson', 'language_id')
