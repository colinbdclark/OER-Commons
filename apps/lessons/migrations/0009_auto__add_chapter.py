...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lessons_chapter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lesson', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chapters', to=orm['lessons.Lesson'])),
        ...
        db.send_create_signal('lessons', ['Chapter'])


    def backwards(self, orm):
        
        # Deleting model 'Chapter'
        db.delete_table('lessons_chapter')
    ...
    models = {
        ...
        'lessons.chapter': {
            'Meta': {'ordering': "['lesson__id', 'order', 'id']", 'object_name': 'Chapter'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chapters'", 'to': "orm['lessons.Lesson']"}),
