...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lesson.created_on'
        db.add_column('lessons_lesson', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 17, 11, 23, 18, 208699), blank=True), keep_default=False)

        # Adding field 'Lesson.modified_on'
        db.add_column('lessons_lesson', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lesson.created_on'
        db.delete_column('lessons_lesson', 'created_on')

        # Deleting field 'Lesson.modified_on'
        db.delete_column('lessons_lesson', 'modified_on')
