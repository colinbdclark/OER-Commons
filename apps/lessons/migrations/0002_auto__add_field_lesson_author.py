...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lesson.author'
        db.add_column('lessons_lesson', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lesson.author'
        db.delete_column('lessons_lesson', 'author_id')
