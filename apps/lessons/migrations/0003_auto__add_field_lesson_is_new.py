...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lesson.is_new'
        db.add_column('lessons_lesson', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lesson.is_new'
        db.delete_column('lessons_lesson', 'is_new')
